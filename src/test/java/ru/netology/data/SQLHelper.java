...
// docker-compose up
// Запуск SUT с поддержкой для MySQL: java -jar artifacts/aqa-shop.jar -P:jdbc.url=jdbc:mysql://localhost:3306/app
// Запуск SUT с поддержкой для Postgres: java -jar artifacts/aqa-shop.jar -P:jdbc.url=jdbc:postgresql://localhost:5432/app
