...
- Выбрать "Купить"
- В поле "Номер карты" рандомный номер карты
- Остальные поля заполнить валидными значениями
- Кликнуть "Продолжить"
...
10 "Отказ", пустое значение поля "Владелец"
...
11 "Отказ", двухзначное значения поля "CVC/CVV"
...
- Выбрать "Купить в кредит"
- В поле "Номер карты" ввести рандомные данные
- Остальные поля заполнить валидными значениями
- Кликнуть "Продолжить"
